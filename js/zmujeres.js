// js/zmujeres.js - Lógica para la colección de mujeres con Modal y Carrito
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        // Filtrar exclusivamente los de categoría mujer
        womenShoesData = data.shoes.filter(shoe => shoe.category === 'mujer');
        
        if (womenShoesData.length === 0) {
        ...
        console.error("Error cargando los productos para mujer:", error);
    ...
    function attachQuickAddEvents() {
        ...
        buttons.forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                const selectedShoe = womenShoesData.find(s => s.id === shoeId);
    ...
    window.openModal = function(shoeId) {
        ...
        modalCurrentShoe = womenShoesData.find(s => s.id === shoeId);
